...
import com.destroflyer.nordicworld.client.MaterialFactory;
...
public class ModelSkin{
    ...
    private void loadFile(String filePath) {
        try {
            Document document = new SAXBuilder().build(new File(ClientApplication.ASSETS_ROOT + filePath));
    ...
    private String getModelFilePath(String modelName, String fileName) {
        for (String FILE_EXTENSION : FILE_EXTENSIONS) {
            ...
            if (new File(ClientApplication.ASSETS_ROOT + modelFilePath).exists()) {
